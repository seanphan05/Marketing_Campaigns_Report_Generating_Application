    ...
    <div class="container">
        <div class="camp_details_form">
            ...
            <div id="submit_details" style="display:none;">
                ...
                <label><strong>New Campaign Details :</strong></label><br>
                <textarea id="campDetailChange" name="message" rows="3" cols="25">New Campaign Details</textarea><br><br>
                <input id="change_details_submit" type="submit" value="Change"/>
            </div>
            <p id="success_message" style="display:none; color: red"><strong>New campaign details has been updated successfully!</strong></p>
        </div>
